    ...
    <cfelse>
        ...
        <cfelse>
            <cftry>
                ...
                <cfset sifreSonuc=sifreleme.sifreUretme(sifre=sifre)>
                <cfset cevapSonuc=sifreleme.sifreUretme(sifre=gizliCevap,tuz=sifreSonuc.tuz)>
                <cfquery datasource="DSN">
                    ...
                    <cfqueryparam value="#sifreSonuc.hash#" cfsqltype="cf_sql_varchar">,
                    <cfqueryparam value="#sifreSonuc.tuz#" cfsqltype="cf_sql_varchar">,
                    <cfqueryparam value="#sifreSonuc.hashSurum#" cfsqltype="cf_sql_integer">,
                    <cfqueryparam value="#gizliSoruID#" cfsqltype="cf_sql_integer">,
                    <cfqueryparam value="#cevapSonuc.hash#" cfsqltype="cf_sql_varchar">,
                    0,
                    GETDATE(),
                    1
                    )
                ...
                <cfcatch type="database">
                    ...
                    <cfelse>
                        ...
                        <cfset aiHata.hataYazma(
                            sayfa="/YKSSite/views/kimlik/kayit.cfm",
                            islem="kayitOl",
        ...
        <section class="kart">
            ...
            <div class="kart__govde">
                ...
                <cfelse>
                    ...
                    <p class="sessiz" style="text-align:center">Zaten üye misiniz? <a class="bag" href="/YKSSite/views/kimlik/giris.cfm">Giriş Yap</a></p>
                </cfif>
            </div>
        </section>
    </div>
