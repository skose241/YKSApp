...
<cfset okunmamisAdet=0>
<cfif oturumKontrol>
    <cfif structKeyExists(request,"okunmamisAdet")>
        <cfset okunmamisAdet=val(request.okunmamisAdet)>
    <cfelse>
        ...
        <cfset okunmamisAdet=val(qOkunmamis.adet)>
    </cfif>
</cfif>
...
<html lang="tr" data-tema="gunduz">
    <head>
        <cfoutput>
            ...
            <link href="/YKSSite/assets/images/favicon.ico" rel="icon" type="image/x-icon" sizes="32x32">
            <link href="/YKSSite/assets/images/icon-512.png" rel="apple-touch-icon" sizes="180x180">
        </cfoutput>
                ...
                <div class="ust-bar__ic">
                    ...
                    <cfif oturumKontrol>
                        ...
                        <a class="simge-dugme zil" href="/YKSSite/views/bildirim/bildirimler.cfm" aria-label="Bildirimler">
                            ...
                            <cfif okunmamisAdet GT 0>
                                <span class="zil__sayi veri" aria-hidden="true">#okunmamisAdet GT 9 ? "9+":okunmamisAdet#</span>
                                <span class="gizli-metin">#okunmamisAdet# adet okunmamış bildirim</span>
                            </cfif>
                        </a>
                        ...
                        <details class="hesap">
                            <summary class="hesap__dugme" aria-label="Hesap menüsü">
                                <span class="hesap__harf">#encodeForHTML(uCase(left(SESSION.kullaniciAd,2)))#</span>
                            </summary>
