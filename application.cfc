<cfcomponent output="false">
    ...
    <cffunction name="referansYukle" access="private" returntype="void" output="false">
        <cfset var qAlanYeni="">
        <cfset var qDersYeni="">
        <cflock name="YKSSite_referansYukle" type="exclusive" timeout="10">
            <cfquery name="qAlanYeni" datasource="#application.DSN#">
                SELECT id,ad
                FROM Alan
                ORDER BY id
            </cfquery>

            <cfquery name="qDersYeni" datasource="#application.DSN#">
                SELECT id,ad,alanID
                FROM Ders
                ORDER BY ad
            </cfquery>
            <cfset application.qAlan=qAlanYeni>
    ...
    <cffunction name="onApplicationStart" returntype="boolean" output="false">
        ...
        <cfset application.varlikSurum="2.5.0">
